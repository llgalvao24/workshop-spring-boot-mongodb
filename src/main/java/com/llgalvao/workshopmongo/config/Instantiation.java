package com.llgalvao.workshopmongo.config;

import com.llgalvao.workshopmongo.DTO.AuthorDTO;
import com.llgalvao.workshopmongo.DTO.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c3 = new CommentDTO("Show!", sdf.parse("23/03/2018"), new AuthorDTO(alex));
